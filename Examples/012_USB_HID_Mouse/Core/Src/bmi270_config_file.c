/*
 * bmi270_config_file.c
 *
 * Mandatory BMI270 initialization ("config") file. The BMI270 will not
 * produce valid accelerometer/gyroscope data until this exact 8192-byte
 * image is uploaded to its internal RAM (see bmi270_init() in bmi270.c).
 *
 * This is a byte-for-byte copy of the array published by Bosch Sensortec in
 * the official BMI270 Sensor API, file bmi270.c, array bmi270_config_file[]:
 * https://github.com/boschsensortec/BMI270-Sensor-API
 *
 * Do not hand-edit any byte in this array.
 */
